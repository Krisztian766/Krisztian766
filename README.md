...
Python/JS developer with a focus on automation and security tooling. I build small, practical systems — from business-process apps to honeypots for malware research — and like understanding things down to the protocol/log level rather than just the surface.

**Currently exploring:** honeypot deployment and log/threat analysis, email automation, embedded/IoT (Arduino).
...
Python · JavaScript · PHP · C++ · Flask

More at [czeczokrisztian.com](https://czeczokrisztian.com).
